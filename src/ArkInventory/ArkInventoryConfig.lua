			...
			args = {
				...
				attunement = {
					...
					args = {
						showAttunement = {
							order = 170,
							name = 'Show Attunement',
							desc = 'Show Attunement progress indicator',
							type = "toggle",
							get = function( info )
								if not ArkInventory.db.profile.option.attunement then return false end
								return ArkInventory.db.profile.option.attunement.enabled or false
							end,
							set = function( info, v )
						...
						colorBlindMode = {
							...
							get = function( info )
								if not ArkInventory.db.profile.option.attunement then return false end
								return ArkInventory.db.profile.option.attunement.colorBlindMode or false
							end,
							set = function( info, v )
								if not ArkInventory.db.profile.option.attunement then ArkInventory.db.profile.option.attunement = {} end
